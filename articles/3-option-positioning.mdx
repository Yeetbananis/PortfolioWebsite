...
The type of an option is determined by the relationship between its strike price and the current price of the underlying stock. This relationship dictates whether an option has any real, tangible value right now, or if its value is purely based on future potential.
...
You can think of it as a riskier bet on your prediction. For example, if you think a 100 dollar stock will go to 150 dollars, you might buy a 120 dollar strike call option for a 2 dollar premium. To start making money, the stock has to rise to your breaken price of 122 dollars (120 dollar strike + 2 dollar premium) by expiration.
...
For example, if you think a 100 dollar stock will go to 150 dollars, you could buy a 100 dollar strike option with a 10 dollar premium. Your breakeven price would be 110 dollars. Notice the premium is much higher than the OTM example; if you only had 10 dollars, you could buy one ATM contract versus five of the OTM contracts.

Since the stock price equals the strike price (`100 dollars - 100 dollars = 0 dollars`), ATM options have no intrinsic value. However, they typically have the highest extrinsic value because they are at the point of maximum uncertainty, with the greatest potential to move into the money.
...
It's like paying for a head start or better insurance in case the price moves against you. For example, if you think a 100 dollar stock will go to 150 dollars, you could buy an 80 dollar strike option. If the premium is 22 dollars, your contract already has 20 dollars of intrinsic value (`100 dollar stock price - 80 dollar strike`). The premium for ITM options is the most expensive because you are paying for that existing intrinsic value plus some remaining extrinsic value.
