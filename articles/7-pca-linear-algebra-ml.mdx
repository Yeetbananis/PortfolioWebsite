...
<div className="border border-neutral-800 bg-neutral-900/50 rounded-xl p-6 my-8">
  <h3 className="text-white font-bold text-sm mb-4">Why is this better? The Student Analogy Revisited</h3>
  
  {/* CHANGED <p> TO <div> TO PREVENT HYDRATION ERRORS */}
  <div className="text-sm text-neutral-300 mb-4">
    Imagine a student who is studying for a linear algebra test. The key idea is that a matrix is not invertible if its determinant is zero.
  </div>

  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-xs">
    <div className="bg-green-900/20 border border-green-500/30 p-4 rounded">
      <strong className="text-green-400 block mb-2">Student A (Uses PCA logic)</strong>
      Memorizes one core fact: "Determinant Zero = Not Invertible." Simple, clean signal.
    </div>
    <div className="bg-red-900/20 border border-red-500/30 p-4 rounded">
      <strong className="text-red-400 block mb-2">Student B (Overfitting)</strong>
      Memorizes every logic chain separately: "Det 0 means columns dependent... which means rows dependent... which means null space nontrivial..."
    </div>
  </div>

  {/* CHANGED <p> TO <div> */}
  <div className="text-sm text-neutral-300 mt-4">
    When asked a question, Student B tries to follow all separate chains, overcomplicates reasoning, and might get confused. Memorizing every equivalent fact separately is a human version of overfitting your memory to redundant details. Student A (PCA) spends effort on the true clear signal.
  </div>
</div>
