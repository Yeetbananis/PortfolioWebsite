...
When trying to utilize liquidity on the chart as a trader you can think of two types:

- **Buy side liquidity**: Liquidity created from buyers in the market, usually located at **highs of different times frames** (1HR, Daily, Weekly etc). If you are a buyer in the market, your take profit (sell order), is usually one of these highs, therefore when price sweeps a zone like this your order triggered and contributes to pushing price down. If you are a seller in the market, your stop loss (buy order) is usually one of these highs, therefore when price sweeps these zones you are forced to sell and your order pushes the price up.
- **Sell side liquidity**: Liquidity created from sellers in the market, usually located at **lows of different time frames**. If you are a seller in the market, your take profit is usually the low of a certain time frame, therefore when price sweeps this low your buy order activates and you push price up. If you are a buyer in the market your stop loss is usually the low of a certain time frame, therefore when price sweeps this zone your sell order activates and you push price down.
...
<SmoothVideo
  ...
  poster="/images/support_resistance_poster.png"
/>
...
<SmoothVideo
  ...
  poster="/images/optimize_training_poster.png"
/>
...
<SmoothVideo
  ...
  poster="/images/kfold_validation_poster.png"
/>
